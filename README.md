...
This repository containes my first analysis workflor using Qiita (https://qiita.ucsd.edu/) and Qiime 2 (https://qiime2.org/).
It process and analyse 16s rRNA data from my raw reads to diversity analysis and taxonomy

Notes 📊 : 
-Taxonomy was assigned using SILVA 138 classifier
...
8. **Visualizations** (barplots, diversity plots, pcoa)
...
# This is a code using a Python package to create a rep_set.fna, which contains one representative sequence per OUT.
...
# Parse OTU file and write representative sequences
...
#filtering
# filtering Mitochondria, Chloroplast, Samples with less than 5 reads
...
# Converting Biom table into TSV
biom convert \
...
# Now the qza needs to be fixed by biom
biom convert \
