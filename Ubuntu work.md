...
🛠️**mkdir** - make directory (the file we want to create)
```bash
...
```
🛠️ **fastq_dir=** will create a variable where the path to the directory/folder where the FASTQ files are saved
```bash
